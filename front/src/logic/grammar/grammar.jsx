...
function peg$parse(input, options) {
  ...
  var peg$e16 = peg$otherExpectation("list");
  var peg$e17 = peg$otherExpectation("Unicode character");
  var peg$e18 = peg$anyExpectation();
  var peg$e19 = peg$otherExpectation("character");
  ...
  function peg$parseconcat() {
    ...
    s1 = peg$currPos;
    s2 = peg$parse_();
    s3 = peg$parserepeatedExpression();
    if (s3 !== peg$FAILED) {
      s4 = peg$parse_();
      s2 = [s2, s3, s4];
      s1 = s2;
