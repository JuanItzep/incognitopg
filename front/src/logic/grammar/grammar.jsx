...
function peg$parse(input, options) {
  ...
  var peg$e10 = peg$otherExpectation("range");
  var peg$e11 = peg$literalExpectation("[", false);
  var peg$e12 = peg$literalExpectation("-", false);
  var peg$e13 = peg$literalExpectation("]", false);
  var peg$e14 = peg$otherExpectation("list");
  var peg$e15 = peg$otherExpectation("Unicode character");
  var peg$e16 = peg$anyExpectation();
  var peg$e17 = peg$otherExpectation("character");
  ...
  var peg$f0 = function(identifier, definition) {
      //return resolveRules(definition);
    };
  var peg$f1 = function(expr, identifier) {
      return { expr };
    };
  ...
  var peg$f6 = function(startChar, endChar) {
  ...
  function peg$parsechoiceExpression() {
    ...
    s0 = peg$currPos;
    s1 = peg$parse_();
    s2 = peg$parserepeatedExpression();
    if (s2 !== peg$FAILED) {
      s3 = peg$parse_();
      s4 = [];
      s5 = peg$currPos;
      ...
      if (s7 !== peg$FAILED) {
        s8 = peg$parse_();
        s9 = peg$parserepeatedExpression();
        if (s9 !== peg$FAILED) {
          s6 = [s6, s7, s8, s9];
          s5 = s6;
        } else {
