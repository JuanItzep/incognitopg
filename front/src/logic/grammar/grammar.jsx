...
function peg$parse(input, options) {
  ...
  var peg$e4 = peg$otherExpectation("grouped expression");
  var peg$e5 = peg$literalExpectation("(", false);
  var peg$e6 = peg$literalExpectation(")", false);
  var peg$e7 = peg$otherExpectation("rule reference");
  var peg$e8 = peg$otherExpectation("identifier");
  ...
  var peg$e15 = peg$otherExpectation("list");
  var peg$e16 = peg$otherExpectation("Unicode character");
  var peg$e17 = peg$anyExpectation();
  var peg$e18 = peg$otherExpectation("character");
  var peg$e19 = peg$classExpectation(["]", "-"], true, false);
  var peg$e20 = peg$otherExpectation("string");
  ...
  var peg$f0 = function(definitions) {
      return resolveRules(definitions);
    };
  var peg$f1 = function(identifier, expr) {
  ...
  var peg$f3 = function(expr, Operator) {
  ...
  var peg$f5 = function(identifier) {
      return { type: 'ruleReference', name: identifier };
    };
  var peg$f6 = function() {
      return text();
    };
  var peg$f7 = function(startChar, endChar) {
  ...
  function peg$parsechoiceExpression() {
    ...
    s0 = peg$currPos;
    s1 = peg$parserepeatedExpression();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_();
      ...
      if (s5 !== peg$FAILED) {
        s6 = peg$parse_();
        s7 = peg$parserepeatedExpression();
        if (s7 !== peg$FAILED) {
          s4 = [s4, s5, s6, s7];
          s3 = s4;
        } else {
  ...
  function peg$parseruleReference() {
    var s0, s1;
