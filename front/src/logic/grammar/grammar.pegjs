...
start
  = _ identifier:identifier _ definition:definition+ _ {
      //return resolveRules(definition);
    }

definition
  = _ "=" _ expr:choiceExpression _ ";"? _ identifier:identifier? _ {
      return { expr };
    }

choiceExpression
  = head: _ repeatedExpression _
...
repeatedExpression
    = _ expr:expression _ Operator:("*"/"+"/"?") _ {
